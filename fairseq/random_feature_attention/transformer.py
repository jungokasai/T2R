...
class RFADecoder(FairseqIncrementalDecoder):
    """
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        self.random_matrices = load_random_matrices(
            ...
            dtype=self.embed_tokens.embeddings[0][0].weight.dtype,
            )
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        return RFADecoderLayer(args, no_encoder_attn)
    ...
    def extract_features_scriptable(
        ...
        for idx, layer in enumerate(self.layers):
            ...
            x = layer(
                x,
                random_matrices[idx] if self.training else random_matrices,
